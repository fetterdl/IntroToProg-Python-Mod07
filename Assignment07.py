...
#   DFetters,6/12/2024,Created Script
# ------------------------------------------------------------------------------------------ #
import json
import io
...
class FileProcessor:
    ...
    DFetters,6.12.2024,Created Class
    """
    @staticmethod
    def read_data_from_file(file_name: str, student_data: list):
        ...
        ChangeLog: (Who, When, What)
        DFetters,6.12.2024,Created function
...
class IO:
    ...
    ChangeLog: (Who, When, What)
    DFetters,6.12.2024,Created Class
    DFetters,6.12.2024,Added menu output and input functions
    DFetters,6.12.2024,Added a function to display the data
    DFetters,6.12.2024,Added a function to display custom error messages
    """
...
class Student(Person):
    ...
    """ This class creates a Student object from the Person Class
    ...
    def __int__(self, first_name: str = "", last_name: str = "", course_name: str = ""):
